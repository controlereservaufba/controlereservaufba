...
Militar.create(nome: 'ADMIN TOTAL',nome_guerra:'TOTAL', posto:'CAPITAO')
...
Reserva.create(sigla:'REIM',descricao:'RESERVA QG IM',data: DateTime.now)
Reserva.create(sigla:'REIBIO',descricao:'RESERVA QG IBIO',data: DateTime.now)
Controle.create(reserva_id:1,data_abertura: DateTime.now)
Controle.create(reserva_id:2,data_abertura: DateTime.now)
