...
class ReservasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create reserva" do
    assert_difference('Reserva.count') do
      post reservas_url, params: { reserva: { data: @reserva.data, descricao: @reserva.descricao, sigla: @reserva.sigla, status: @reserva.status, user_id: @reserva.user_id } }
    end
  ...
  test "should update reserva" do
    patch reserva_url(@reserva), params: { reserva: { data: @reserva.data, descricao: @reserva.descricao, sigla: @reserva.sigla, status: @reserva.status, user_id: @reserva.user_id } }
